...
for i in range(0,len(clustered_T_Air)):
    if i % 24 == 0:
        if round(clustered_T_Air[i], 2) == round(clustered["T_Air_12"][0][0], 2):
        ...
        elif clustered_T_Air[i] == clustered["T_Air_12"][1][0]:
            with open("input_data/Medoid/TWW/outcome_2.csv", 'r') as file:
                ...
                third = [float(row[2]) for row in reader]
                fourth = [float(row[3]) for row in reader]
        elif round(clustered_T_Air[i], 2) == round(clustered["T_Air_12"][2][0], 2):
            with open("input_data/Medoid/TWW/outcome_3.csv", 'r') as file:
                ...
                fourth = [float(row[3]) for row in reader]
 #               print("True")
        elif clustered_T_Air[i] == clustered["T_Air_12"][3][0]:
            with open("input_data/Medoid/TWW/outcome_4.csv", 'r') as file:
                ...
                third = [float(row[2]) for row in reader]
                fourth = [float(row[3]) for row in reader]
        elif clustered_T_Air[i] == clustered["T_Air_12"][4][0]:
            with open("input_data/Medoid/TWW/outcome_5.csv", 'r') as file:
                ...
                third = [float(row[2]) for row in reader]
                fourth = [float(row[3]) for row in reader]
        elif clustered_T_Air[i] == clustered["T_Air_12"][5][0]:
            with open("input_data/Medoid/TWW/outcome_6.csv", 'r') as file:
                ...
                third = [float(row[2]) for row in reader]
                fourth = [float(row[3]) for row in reader]
        elif clustered_T_Air[i] == clustered["T_Air_12"][6][0]:
            with open("input_data/Medoid/TWW/outcome_7.csv", 'r') as file:
                ...
                third = [float(row[2]) for row in reader]
                fourth = [float(row[3]) for row in reader]
        elif clustered_T_Air[i] == clustered["T_Air_12"][7][0]:
...
#with open(f"ClusteredYear_normal.csv", "w", newline="") as f:
#    writer = csv.writer(f)
